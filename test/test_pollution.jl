...
function test_load_pollution_data()
...
function test_pollution_table()
    @testset "test PollutionTable" begin
        test_pollution_table_constructor_data()
        test_pollution_table_constructor_no_data()
    end
end

function test_pollution_table_constructor_no_data()
...
function test_pollution_table_constructor_data()
...
@testset "test pollution" begin
    test_load_pollution_data()
